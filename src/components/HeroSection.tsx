        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-10 lg:gap-16">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="animate-fade-up-delay-1">
              <p className="text-lg md:text-xl text-foreground/80 max-w-2xl mx-auto lg:mx-0 mb-8 leading-relaxed font-medium drop-shadow-[0_1px_8px_hsl(var(--background))]">
            ...
            <div className="animate-fade-up-delay-2">
              <div className="inline-block bg-background/80 backdrop-blur-sm border border-border rounded-2xl p-6 md:p-8 shadow-lg">
          ...
          <div className="animate-fade-up-delay-2 w-full lg:w-80 flex-shrink-0">
