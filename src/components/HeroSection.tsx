      ...
      <div className="container mx-auto max-w-5xl relative z-10">
        <div className="text-center mb-12">
          <div className="animate-fade-up">
            <Link
              to="/changelog"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-melasmart-green-dark/10 border border-melasmart-green-dark/20 mb-6 backdrop-blur-sm hover:bg-melasmart-green-dark/20 hover:border-melasmart-green-dark/40 transition-colors"
              aria-label="Vai al changelog"
            >
              <span className="relative flex h-2.5 w-2.5">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-melasmart-green-dark opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-melasmart-green-dark"></span>
              </span>
