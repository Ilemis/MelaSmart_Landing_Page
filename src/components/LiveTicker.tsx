...
const LiveTicker = () => {
  ...
  return (
    <div className="relative overflow-hidden mb-6 max-w-2xl mx-auto rounded-full border border-primary/20 bg-background/40 backdrop-blur-md">
      ...
      <div className="flex gap-8 py-2 animate-marquee whitespace-nowrap">
        {loop.map((t, i) => (
          <span key={i} className="text-xs md:text-sm text-foreground/80 font-medium flex items-center gap-2">
